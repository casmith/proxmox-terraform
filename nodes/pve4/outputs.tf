...
output "ubuntu_vm_details" {
  description = "Detailed information about Ubuntu VMs on pve4"
  value       = try(module.ubuntu_vms[0].vm_details, {})
}

output "ubuntu_vm_ips" {
  description = "IP addresses of Ubuntu VMs on pve4"
...
output "ubuntu_highmem_vm_details" {
  description = "Detailed information about high-memory Ubuntu VMs on pve4"
  value       = try(module.ubuntu_highmem_vms[0].vm_details, {})
}

output "ubuntu_highmem_vm_ips" {
  description = "IP addresses of high-memory Ubuntu VMs on pve4"
...
output "talos_vm_details" {
  description = "Detailed information about Talos VMs on pve4"
  value       = try(module.talos_vms[0].vm_details, {})
}

output "talos_vm_ips" {
  description = "IP addresses of Talos VMs on pve4"
...
output "talos_sandbox_vm_details" {
  description = "Detailed information about Talos Sandbox VMs on pve4"
  value       = try(module.talos_sandbox_vms[0].vm_details, {})
}

output "talos_sandbox_vm_ips" {
  description = "IP addresses of Talos Sandbox VMs on pve4"
...
output "all_vms" {
  description = "All VMs on pve4 grouped by type"
  value = {
