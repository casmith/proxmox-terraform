...
output "windows_vm_details" {
  description = "Detailed information about Windows VMs on pve1"
  value       = try(module.windows_vms[0].vm_details, {})
}

output "windows_vm_ips" {
  description = "IP addresses of Windows VMs on pve1"
...
output "freebsd_vm_details" {
  description = "Detailed information about FreeBSD VMs on pve1"
  value       = try(module.freebsd_vms[0].vm_details, {})
}

output "freebsd_vm_ips" {
  description = "IP addresses of FreeBSD VMs on pve1"
