...
output "ubuntu_vm_details" {
  description = "Detailed information about Ubuntu VMs on pve3"
  value       = try(module.ubuntu_vms[0].vm_details, {})
}

output "ubuntu_vm_ips" {
  description = "IP addresses of Ubuntu VMs on pve3"
...
output "ubuntu_highmem_vm_details" {
  description = "Detailed information about high-memory Ubuntu VMs on pve3"
  value       = try(module.ubuntu_highmem_vms[0].vm_details, {})
}

output "ubuntu_highmem_vm_ips" {
  description = "IP addresses of high-memory Ubuntu VMs on pve3"
...
output "talos_vm_details" {
  description = "Detailed information about Talos VMs on pve3"
  value       = try(module.talos_vms[0].vm_details, {})
}

output "talos_vm_ips" {
  description = "IP addresses of Talos VMs on pve3"
...
output "talos_sandbox_vm_details" {
  description = "Detailed information about Talos Sandbox VMs on pve3"
  value       = try(module.talos_sandbox_vms[0].vm_details, {})
}

output "talos_sandbox_vm_ips" {
  description = "IP addresses of Talos Sandbox VMs on pve3"
...
output "windows_vm_details" {
  description = "Detailed information about Windows VMs on pve3"
  value       = try(module.windows_vms[0].vm_details, {})
}

output "windows_vm_ips" {
  description = "IP addresses of Windows VMs on pve3"
...
output "freebsd_vm_details" {
  description = "Detailed information about FreeBSD VMs on pve3"
  value       = try(module.freebsd_vms[0].vm_details, {})
}

output "freebsd_vm_ips" {
  description = "IP addresses of FreeBSD VMs on pve3"
...
output "all_vms" {
  description = "All VMs on pve3 grouped by type"
  value = {
