...
module "pve5" {
  ...
  ubuntu_vm_name          = var.pve5_ubuntu_vm_name
  ubuntu_vm_cores         = var.pve5_ubuntu_vm_cores
  ubuntu_vm_memory        = var.pve5_ubuntu_vm_memory
  ubuntu_vm_disk_size     = var.pve5_ubuntu_vm_disk_size
  ubuntu_vm_user          = var.pve5_ubuntu_vm_user
  ubuntu_vm_tags          = var.pve5_ubuntu_vm_tags
  ubuntu_vm_mac_addresses = var.pve5_ubuntu_vm_mac_addresses

  # Ubuntu High-Memory VM configuration
  ubuntu_highmem_vm_count         = var.pve5_ubuntu_highmem_vm_count
  ubuntu_highmem_vm_name          = var.pve5_ubuntu_highmem_vm_name
  ubuntu_highmem_vm_cores         = var.pve5_ubuntu_highmem_vm_cores
  ubuntu_highmem_vm_memory        = var.pve5_ubuntu_highmem_vm_memory
  ubuntu_highmem_vm_disk_size     = var.pve5_ubuntu_highmem_vm_disk_size
  ubuntu_highmem_vm_mac_addresses = var.pve5_ubuntu_highmem_vm_mac_addresses

  # Talos VM configuration
  talos_vm_count         = var.pve5_talos_vm_count
  talos_vm_name          = var.pve5_talos_vm_name
  talos_vm_cores         = var.pve5_talos_vm_cores
  talos_vm_memory        = var.pve5_talos_vm_memory
  talos_vm_disk_size     = var.pve5_talos_vm_disk_size
  talos_vm_tags          = var.pve5_talos_vm_tags
  talos_vm_mac_addresses = var.pve5_talos_vm_mac_addresses

  # Talos Sandbox VM configuration
  talos_sandbox_vm_count         = var.pve5_talos_sandbox_vm_count
  talos_sandbox_vm_name          = var.pve5_talos_sandbox_vm_name
  talos_sandbox_vm_cores         = var.pve5_talos_sandbox_vm_cores
  talos_sandbox_vm_memory        = var.pve5_talos_sandbox_vm_memory
